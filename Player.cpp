...
{
	this->playerTexture.loadFromFile("res\\textures\\player2.png");
...
void Player::addForces(sf::Vector2f _forces)
{
	if (movable)
	{
		//_forces /= 2.f;
		velocity += _forces;
	//	if (velocity.x > 180 || velocity.y > 180)
	//		//velocity.x = 180; velocity.y = 180;
